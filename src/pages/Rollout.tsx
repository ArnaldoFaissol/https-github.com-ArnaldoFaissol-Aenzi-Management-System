...
import { BACKLOG_SITES } from '@/lib/mock-data'
  ...
  return (
    <div className="flex flex-col gap-6 animate-slide-up">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {BACKLOG_SITES.map((site, i) => {
          // Mock varying SLA days
          const daysLeft = 45 - i * 12
              ...
              <CardContent className="p-5">
                <div className="flex justify-between items-start mb-4">
                  <div className="space-y-1">
                    ...
                    <h3 className="font-medium leading-none">{site.name}</h3>
                  </div>
                ...
                <div className="flex items-center gap-2 text-sm mt-4 pt-4 border-t">
                  ...
                  />
                  <span
                    className={isDanger ? 'text-destructive font-medium' : 'text-muted-foreground'}
                  >
